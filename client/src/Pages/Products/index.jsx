...
export default function Products() {
  ...
  const categoryName = categoryId == "all" ? 'All Rooms' : 
                      categoryId == "az6509on5rk4j7th7v8ne52b" ? 'Living Room' : 
                      categoryId == "waxaaodtymuwyceni5nhsrrn" ? 'Bedroom' : 
                      categoryId == "a16st8eewesjhp0xal741ijf" ? 'Kitchen' : '';

  const categories = [
    { id: "all", name: "All Rooms", path: "/products/all/all-category" },
    { id: "az6509on5rk4j7th7v8ne52b", name: "Living Room", path: "/products/az6509on5rk4j7th7v8ne52b/Living-Room" },
    { id: "waxaaodtymuwyceni5nhsrrn", name: "Bedroom", path: "/products/waxaaodtymuwyceni5nhsrrn/Bedroom" },
    { id: "a16st8eewesjhp0xal741ijf", name: "Kitchen", path: "/products/a16st8eewesjhp0xal741ijf/Kitchen" },
  ];
  ...
  const drawerContent = (
    <Box sx={{ p: 3, width: 280 }}>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: "32px", alignItems: "flex-start" }}>
        <Box sx={{ display: "flex", flexDirection: "column", gap: "24px", alignItems: "start", width: "100%" }}>
          <Typography fontWeight={"bold"} fontSize={"24px"}>
            CATEGORIES
          </Typography>
          {categories.map((cat) => (
            <Typography
              ...
              sx={{
                ...
                cursor: "pointer",
                borderBottom: categoryId == cat.id ? "2px solid black" : "2px solid transparent",
                transition: "all .5s",
                fontSize: "16px",
                width: "100%",
                pb: 1,
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          Home <ArrowForwardIosIcon sx={{ fontSize: { xs: "10px", sm: "12px", md: "14px" } }} /> Shop
        </Typography>
        <Typography
          sx={{
            wordSpacing: "10px",
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          ...
          >
            {!isMobile && <TuneRoundedIcon sx={{ fontSize: { xs: "18px", sm: "20px", md: "24px" }, fontWeight: "bold" }} />}
        ...
        <Typography sx={{ 
          ...
          fontWeight: "bold",
          textAlign: "center",
          transform: { xs: "translateX(0)", sm: "translateX(-100px)", md: "translateX(-200px)", lg: "translateX(-330px)" },
          order: { xs: 3, sm: 2 },
        ...
        <Box sx={{ 
          ...
          >
            ...
            {!isMobile && (
              <>
                <ViewModuleRoundedIcon sx={{ rotate: "90deg", fontSize: { xs: "18px", sm: "20px", md: "24px" } }} />
                <GridViewRoundedIcon sx={{ opacity: "0.5", fontSize: { xs: "18px", sm: "20px", md: "24px" } }} />
                <ViewAgendaRoundedIcon sx={{ rotate: "90deg", opacity: "0.5", fontSize: { xs: "18px", sm: "20px", md: "24px" } }} />
              </>
            )}
          </Box>
        </Box>
